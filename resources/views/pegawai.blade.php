        ...
        {{-- form search data --}}
            ...
            <div class="col-5 my-4">
                <form class="d-flex" role="search">
                    <input type="search" name="cariPegawai" class="form-control me-2" placeholder="Search" aria-label="Search">
            ...
            <div class="col-5 my-4">
                <form class="d-flex" action="/pegawai/cari" method="GET">
                    <input type="text" name="cariPegawai" class="form-control me-2" 
